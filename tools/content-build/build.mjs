...
function contentRecord(record, resolvedAssets) {
  ...
  return {
    ...
    members: record.document.members ?? [],
    entries: record.document.entries ?? [],
    entityType: record.document.entityType ?? null,
    provider: record.document.provider ?? null,
    url: record.document.url ?? null,
    embedUrl: record.document.embedUrl ?? null,
    sourceUrl: record.document.sourceUrl ?? null,
    slug: record.document.slug ?? null,
    privacy: record.document.privacy ?? null,
    inputKinds: record.document.inputKinds ?? [],
    outputKinds: record.document.outputKinds ?? [],
    sourceName: record.document.source ?? null,
    query: record.document.query ?? null,
    schedule: record.document.schedule ?? null,
